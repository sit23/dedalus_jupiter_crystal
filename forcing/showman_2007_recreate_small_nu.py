...
nu = 1e15 * meter**4 / second #used to be about 1e-11, now 1e-25 (dimensions were wrong)
...
exp_name = 'showman_2007_A1_mk12_long_1e15_seed'
output_folder = f'snapshots/{exp_name}'

params_to_store = ['meter', 'second', 'Nphi', 'Ntheta', 'dealias', 'max_timestep', 'stop_sim_time', 'printout', 'R', 'Omega', 'nu', 'g', 'inv_tau_rad', 'showman_s0', 'storm_interval_dim', 'storm_length_dim', 'h_width', 'exp_name', 'output_folder', 'phi0', 'seed']
