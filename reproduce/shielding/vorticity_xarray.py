...
task_list = [d3.load_tasks_to_xarray(f"./reproduce/shielding/diffusion/nu1e5_Bu10b2p5/shielding_snapshots/snapshots_s{snap_num+1}.h5") for snap_num in range(10)]
...
# Download dataset
dataset.to_netcdf('./reproduce/shielding/diffusion/nu1e5.nc') 
