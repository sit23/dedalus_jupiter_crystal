...
mpiexec -n 16 python3 ./balanced/balanced.py &&
mpiexec -n 16 python3 ./balanced/plot_balanced.py ./balanced/balanced_snapshots/*.h5 --output ./balanced/balanced_frames &&
ffmpeg -r 40 -i ./balanced/balanced_frames/write_%06d.png ./balanced/cyclone_balanced.mp4

Stitching two mp4s together:
    - ffmpeg -i ./balanced/cyclone_balanced.mp4 -i ./balanced/cyclone_not.mp4 -filter_complex vstack ./balanced/cyclone_both.mp4
...
snapshots = solver.evaluator.add_file_handler('./balanced/balanced_snapshots', sim_dt=printout, max_writes=10)
